...
*/
    ...
    Route::prefix('itineraries')->group(function () {
        Route::get('itineraries/', [\App\Http\Controllers\ItineraryController::class, 'index']);
        Route::post('itineraries/', [\App\Http\Controllers\ItineraryController::class, 'store']);
        Route::get('itineraries/{id}', [\App\Http\Controllers\ItineraryController::class, 'show']);
        Route::put('itineraries/{id}', [\App\Http\Controllers\ItineraryController::class, 'update']);
