...
*/
    ...
    Route::prefix('itineraries')->group(function () {
        ...
        // Accepts POST payload with userId coming from frontend (from sessionStorage userData, as either _id or id)
        // Handles JSON via Axios – see client code for construction details
